...
![GitHub repo size](https://img.shields.io/github/repo-size/USERNAME/netflix-tableau-dashboard)
![Status](https://img.shields.io/badge/Status-Completed-success)
![License](https://img.shields.io/badge/License-MIT-blue)

---

## 📊 Project Overview (<a href="[https://public.tableau.com/views/YourDashboardName](https://public.tableau.com/app/profile/vivek.nailwal/viz/NetflixContentAnalysis_17705692714560/Dashboard1?publish=yes)" target="_blank">🚀 <strong>Live Dashboard</strong></a>)
...
- How Netflix content is distributed
...
- Visualize genre popularity and release patterns
- Build an intuitive and interactive Tableau dashboard
